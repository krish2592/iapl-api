...
const AboutInfytech = () => {
    ...
    const services = ['Data centers', 'Industrial facilities', 'Laboratories',
        'Residential and commercial buildings', 'Offices', 'Hotels and hospitality',
        'Mixed-use developments', 'Educational and institutional facilities',
        'Restaurants and bars', 'Metro stations', 'Bus terminals',
        'Substations and switchyards', 'Pharmaceuticals', 'Various other industries'
    ];

    const chunkSize = 5;
    const chunkedServices = [];
    function chunkServices(services, chunkSize) {
        for (let i = 0; i < services.length; i+=chunkSize) {
            chunkedServices.push(services.slice(i, i + chunkSize));
        }
        return chunkedServices;
    }
    chunkServices(services, chunkSize);
                ...
                <div className="about-us-container-sub">
                    ...
                    <div><h1 className='our-mission-h1'>Our Missions</h1>
                        ...
                        <div className="about-us-container-sub-content4">
                            {chunkedServices.map((chunkedService, index) => (
                                <div>
                                    {chunkedService.map((service, index) => (
